...
export default function Home() {
  ...
  return (
    <div className="font-sans grid grid-rows-[20px_1fr_20px] items-center justify-items-center min-h-screen p-8 pb-20 gap-16 sm:p-20">
        ...
        <input  name="" className="w-full px-4 py-2 border-black text-black border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition duration-20" id="" placeholder="Usuariooooo" />
        <br />
